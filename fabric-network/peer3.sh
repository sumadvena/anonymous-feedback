...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/professors.uni.edu/peers/peer0.professors.uni.edu/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/professors.uni.edu/peers/peer0.professors.uni.edu/tls/server.key
export CORE_PEER_TLS_ROOTCERT_FILE="${PWD}"/crypto-config/peerOrganizations/professors.uni.edu/peers/peer0.professors.uni.edu/tls/ca.crt
export CORE_PEER_ID=peer0.professors.uni.edu
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/professors.uni.edu/peers/peer0.professors.uni.edu/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8448
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer0.professors.uni.edu
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer0.professors.uni.edu/snapshots
