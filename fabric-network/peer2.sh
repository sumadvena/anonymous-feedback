...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/students.uni.edu/peers/peer1.students.uni.edu/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/students.uni.edu/peers/peer1.students.uni.edu/tls/server.key
...
export CORE_PEER_ID=peer1.students.uni.edu
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/students.uni.edu/peers/peer1.students.uni.edu/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8447
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer1.students.uni.edu
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer1.students.uni.edu/snapshots
