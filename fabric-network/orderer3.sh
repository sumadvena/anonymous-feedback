...
export ORDERER_GENERAL_LOCALMSPDIR="${PWD}"/crypto-config/ordererOrganizations/uni.edu/orderers/orderer3.uni.edu/msp
export ORDERER_GENERAL_TLS_ENABLED=true
export ORDERER_GENERAL_TLS_PRIVATEKEY="${PWD}"/crypto-config/ordererOrganizations/uni.edu/orderers/orderer3.uni.edu/tls/server.key
export ORDERER_GENERAL_TLS_CERTIFICATE="${PWD}"/crypto-config/ordererOrganizations/uni.edu/orderers/orderer3.uni.edu/tls/server.crt
...
export ORDERER_GENERAL_TLS_ROOTCAS="${PWD}"/crypto-config/ordererOrganizations/uni.edu/orderers/orderer3.uni.edu/tls/ca.crt
